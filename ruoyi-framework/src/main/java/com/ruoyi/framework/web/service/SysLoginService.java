...
public class SysLoginService
{
    ...
    public String login(String phonenumber, String password, String code, String uuid)
    {
        ...
        try
        {
            ...
            // 该方法会去调用UserDetailsServiceImpl.loadUserByUsername (参数是手机号)
    ...
    public void loginPreCheck(String phonenumber, String password)
    {
        ...
        {
            AsyncManager.me().execute(AsyncFactory.recordLogininfor(phonenumber, Constants.LOGIN_FAIL, "手机号格式不正确"));
